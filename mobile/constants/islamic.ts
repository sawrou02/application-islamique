...
export const MOTIVATION_HADITHS = [
  ...
  {
    text: "Dieu est beau et Il aime la beauté.",
  ...
  {
    text: "Cherchez le savoir, même jusqu'en Chine.",
    textAr: 'اطْلُبُوا الْعِلْمَ وَلَوْ بِالصِّينِ',
    source: 'Hadith faible / cité souvent',
  },
  {
  ...
  {
    text: "Dieu est doux et Il aime la douceur en toute chose.",
