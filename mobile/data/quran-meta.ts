...
export const RECITERS: Reciter[] = [
  ...
  { id: 'minshawi', name: 'Mohamed Al-Minshawi', nameAr: 'محمد المنشاوي', edition: 'ar.minshawimujawwad' },
  { id: 'abdulbaset', name: 'Abdul Basit', nameAr: 'عبد الباسط', edition: 'ar.abdulbasitmurattal' },
  { id: 'sudais', name: 'Abdul Rahman Al-Sudais', nameAr: 'عبد الرحمن السديس', edition: 'ar.abdurrahmaansudais' },
  { id: 'shuraim', name: 'Saud Al-Shuraim', nameAr: 'سعود الشريم', edition: 'ar.saoodshuraym' },
  { id: 'hudhaify', name: 'Ali Al-Hudhaify', nameAr: 'علي الحذيفي', edition: 'ar.hudhaify' },
