 ...
 *
 * Expo Go SDK 54 bundles a version of Hermes that cannot parse #field syntax,
 * but the hermes-stable Babel profile skips the transform assuming Hermes
 * supports them. This wrapper runs AFTER Babel and cleans up anything Babel
 * left untouched.
 */
...
module.exports.transform = async function transform(params) {
  ...
  if (result.code) {
    // Replace any remaining #field syntax that Babel left in place
